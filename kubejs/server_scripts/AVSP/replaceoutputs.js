...
//COPPER why the fuck do every mod add copper?
	...
	//Copper block
	event.replaceOutput({}, 'silents_mechanisms:copper_block', 'cavesandcliffs:copper_block')
	event.replaceOutput({}, 'tmechworks:copper_block', 'cavesandcliffs:copper_block')
	event.replaceOutput({}, 'mekanism:block_copper', 'cavesandcliffs:copper_block')
	event.replaceOutput({}, 'mysticalworld:copper_block', 'cavesandcliffs:copper_block')
	event.replaceOutput({}, 'thermal:copper_block', 'cavesandcliffs:copper_block')
	event.replaceOutput({}, 'immersiveengineering:storage_copper', 'cavesandcliffs:copper_block')
	event.replaceOutput({}, 'occultism:copper_block', 'cavesandcliffs:copper_block')
	event.replaceOutput({}, 'create:copper_block', 'cavesandcliffs:copper_block')
	event.replaceOutput({}, 'tconstruct:copper_block', 'cavesandcliffs:copper_block')
	event.replaceOutput({}, 'iceandfire:copper_block', 'cavesandcliffs:copper_block')
	event.replaceOutput({}, '#forge:storage_blocks/copper', 'cavesandcliffs:copper_block')
	//Copper nugget
...
//COBALT
	...
	event.replaceOutput({}, '#forge:ingots/cobalt', 'tconstruct:cobalt_ingot')
	//Cobalt block
	event.replaceOutput({}, 'tconstruct:cobalt_block', 'emendatusenigmatica:cobalt_block')
	event.replaceOutput({}, '#forge:storage_blocks/cobalt', 'tconstruct:cobalt_block')
	//Cobalt nugget
	event.replaceOutput({}, 'tconstruct:cobalt_nugget', 'emendatusenigmatica:cobalt_nugget')
	event.replaceOutput({}, '#forge:nuggets/cobalt', 'tconstruct:cobalt_nugget')
//
//
//-----AE2 GEMS-----
//
